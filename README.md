...
2. Follow steps 01-06 in sequence
3. Review and approve each step before proceeding

### For Existing Codebases

Before step 02, run `sldd-99-existing-codebase-understanding-and-context-summary` to ground design decisions in current architecture.
