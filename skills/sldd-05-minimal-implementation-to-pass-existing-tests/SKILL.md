...
- If yes and a SPEC.md already exists: create a new file named `05-minimal-implementation-to-pass-existing-tests.md` in the same directory as the existing SPEC.md, and mark `[x]` next to Step 05 in the Progress checklist, and add a link to `06-verification-and-feedback-report.md` in the Step 06 section.
