...
- If yes and a SPEC.md already exists: create a new file named `03-low-level-design-and-version-policy.md` in the same directory as the existing SPEC.md, and mark `[x]` next to Step 03 in the Progress checklist, and add a link to `03-low-level-design-and-version-policy.md`.
