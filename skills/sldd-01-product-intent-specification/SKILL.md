...
- If yes and a SPEC.md already exists: create a new file named `01-product-intent-specification.md` in the same directory as the existing SPEC.md, and mark `[x]` next to Step 01 in the Progress checklist, and add a link to `01-product-intent-specification.md`.
